...
public class ResultadoServicelmpl implements ResultadoService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<Object[]> cantidadAreasMes(String mes){
        return resultadoRepository.cantidadAreasMes(mes);
    }

    @Override
    @Transactional(readOnly = true)
    public List<Object[]> ingresoAreasMes(String mes){
        return resultadoRepository.ingresoAreasMes(mes);
    }
}
